...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & MyApp.context
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) MyApp.context.getSystemService(
   ...
   /* public static String getUdid() {
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & MyApp.context.getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = MyApp.context
                    .getPackageManager();
            boolean flag = pckMgr
...
/*    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) MyApp.context.getSystemService(
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = MyApp.context.getPackageManager()
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (MyApp.context.getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static boolean isPortrait() {
        boolean flag = true;
        if (MyApp.context.getResources().getConfiguration().orientation != 1)
            flag = false;
        return flag;
    }
    ...
    public static void showSoftKeyboard(View view) {
        if (view == null)
            return;
        /*
        ((InputMethodManager) MyApp.context.getSystemService(
    ...
    public static String getCurCountryLan() {
        return MyApp.context.getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + MyApp.context.getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = MyApp.context.getResources()
    ...
    public static PackageInfo getPackageInfo(String pckName) {
        try {
            return MyApp.context.getPackageManager()
                    .getPackageInfo(pckName, 0);
        } catch (NameNotFoundException e) {
            e.printStackTrace();
        }
    ...
    public static int getVersionCode() {
        int versionCode = 0;
        try {
            versionCode = MyApp.context
                    .getPackageManager()
                    .getPackageInfo(MyApp.context.getPackageName(),
                            0).versionCode;
    ...
    public static int getVersionCode(String packageName) {
        int versionCode = 0;
        try {
            versionCode = MyApp.context.getPackageManager()
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) MyApp.context
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = MyApp.context.getPackageManager()
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) MyApp.context
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = MyApp.context.getResources()
                    .getDimensionPixelSize(x);
